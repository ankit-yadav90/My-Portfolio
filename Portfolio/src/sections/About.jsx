...
const About = () => {
  ...
  return (
    ...
    <div className='relative z-10 max-w-6xl w-full mx-auto px-6 md:px-6 lg:px-12 py-20 flex flex-col gap-12 '>
      ...
      >
        ...
        shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20  border-[#00bf8f]/25'>
        ...
        <div className='flex-1 flex flex-col justify-center text-center md:text-left'>
          ...
          <p className='mt-4 text-gray-300 leading-relaxed text-base md:text-lg max-w-2xl md:max-w-3xl'>
